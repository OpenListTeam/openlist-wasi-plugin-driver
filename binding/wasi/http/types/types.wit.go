...
// Package types represents the imported interface "wasi:http/types@0.2.7".
//
...
import (
	...
	ioerror "github.com/OpenListTeam/openlist-wasi-plugin-driver/binding/wasi/io/error"
...
// Duration represents the type alias "wasi:http/types@0.2.7#duration".
//
// See [monotonicclock.Duration] for more information.
type Duration = monotonicclock.Duration

// InputStream represents the imported type alias "wasi:http/types@0.2.7#input-stream".
//
// See [streams.InputStream] for more information.
type InputStream = streams.InputStream

// OutputStream represents the imported type alias "wasi:http/types@0.2.7#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// IOError represents the imported type alias "wasi:http/types@0.2.7#io-error".
//
// See [ioerror.Error] for more information.
type IOError = ioerror.Error

// Pollable represents the imported type alias "wasi:http/types@0.2.7#pollable".
//
// See [poll.Pollable] for more information.
type Pollable = poll.Pollable

// Method represents the variant "wasi:http/types@0.2.7#method".
//
...
// Scheme represents the variant "wasi:http/types@0.2.7#scheme".
//
...
// DNSErrorPayload represents the record "wasi:http/types@0.2.7#DNS-error-payload".
//
...
// TLSAlertReceivedPayload represents the record "wasi:http/types@0.2.7#TLS-alert-received-payload".
//
...
// FieldSizePayload represents the record "wasi:http/types@0.2.7#field-size-payload".
//
...
// ErrorCode represents the variant "wasi:http/types@0.2.7#error-code".
//
...
// HeaderError represents the variant "wasi:http/types@0.2.7#header-error".
//
...
// FieldKey represents the string "wasi:http/types@0.2.7#field-key".
//
...
// FieldName represents the type alias "wasi:http/types@0.2.7#field-name".
//
// See [FieldKey] for more information.
type FieldName = FieldKey

// FieldValue represents the list "wasi:http/types@0.2.7#field-value".
//
...
// Fields represents the imported resource "wasi:http/types@0.2.7#fields".
//
...
// Headers represents the imported type alias "wasi:http/types@0.2.7#headers".
//
// See [Fields] for more information.
type Headers = Fields

// Trailers represents the imported type alias "wasi:http/types@0.2.7#trailers".
//
// See [Fields] for more information.
type Trailers = Fields

// IncomingRequest represents the imported resource "wasi:http/types@0.2.7#incoming-request".
//
...
// OutgoingRequest represents the imported resource "wasi:http/types@0.2.7#outgoing-request".
//
...
// RequestOptions represents the imported resource "wasi:http/types@0.2.7#request-options".
//
...
// ResponseOutparam represents the imported resource "wasi:http/types@0.2.7#response-outparam".
//
...
// StatusCode represents the u16 "wasi:http/types@0.2.7#status-code".
//
...
// IncomingResponse represents the imported resource "wasi:http/types@0.2.7#incoming-response".
//
...
// IncomingBody represents the imported resource "wasi:http/types@0.2.7#incoming-body".
//
...
// FutureTrailers represents the imported resource "wasi:http/types@0.2.7#future-trailers".
//
...
// OutgoingResponse represents the imported resource "wasi:http/types@0.2.7#outgoing-response".
//
...
// OutgoingBody represents the imported resource "wasi:http/types@0.2.7#outgoing-body".
//
...
// FutureIncomingResponse represents the imported resource "wasi:http/types@0.2.7#future-incoming-response".
//
